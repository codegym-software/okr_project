...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>Xin chào <strong><?php echo e($recipientName); ?></strong>,</p>
            ...
            <div class="button-container">
                <a href="<?php echo e($actionUrl); ?>" class="button"><?php echo e($actionText ?? 'Xem chi tiết'); ?></a>
            </div>
            <?php endif; ?>
        </div>
        ...
        <div class="footer">
            ...
            <p>
                <a href="<?php echo e(config('app.url')); ?>">Truy cập hệ thống</a>
            </p>
        </div>
    </div>
</body>
...
<?php /**PATH E:\okr\OKR_Project_main (2)\OKR_Project_main\resources\views/emails/notification.blade.php ENDPATH**/ ?>