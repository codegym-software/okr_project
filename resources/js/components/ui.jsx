...
export function Modal({ open, onClose, title, children, maxWidth = 'max-w-2xl', maxHeight = 'max-h-[100vh]' }) {
    if (!open) return null;
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            <div className="absolute inset-0 bg-black/30" onClick={onClose} />
            <div className={`relative w-full ${maxWidth} ${maxHeight} rounded-2xl bg-white shadow-xl flex flex-col`}>
