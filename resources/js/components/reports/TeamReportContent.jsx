...
import { FiAlertCircle, FiCheckCircle, FiClock, FiTrendingUp, FiTrendingDown, FiMinus } from "react-icons/fi";
...
export default function TeamReportContent({ 
    reportData, 
    onRemind, 
    remindingMap = {},
    isReadOnly = false,
                                ...
                                <tr key={member.user_id} className="hover:bg-slate-50/50 transition-colors group">
                                    ...
                                    {!isReadOnly && (
                                        <td className="px-6 py-4 text-right">
                                            <button 
                                                onClick={() => onRemind && onRemind(member.user_id, member.full_name)}
